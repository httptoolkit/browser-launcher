...
interface BrowserDefinitions {
    [browserType: string]: BrowserConfig;
}
...
const browserDefinitions: BrowserDefinitions = {
    chrome: {
 ...
 */
class Browsers {
    private browserList: BrowserDefinitions;

    constructor(browserList?: BrowserDefinitions) {
     ...
     *
     * @returns list of browser data
     */
    browserPlatforms(): BrowserPlatform[] {
     ...
     * @returns config for the specified browser type
     */
    typeConfig(type: string): Omit<BrowserConfig, 'variants'> {
