...
function Instance( options ) {
	...
	// on Windows Opera uses a launcher which is stopped immediately after opening a browser
	// TODO how to handle a browser crash then?
...
Instance.prototype.stop = function( callback ) {
	...
	if ( process.platform === 'win32' ) {
		child.exec( 'taskkill /F /IM ' + ( this.image || basename( this.command ) ) )
