...
setups.firefox = function (browser, options, callback) {
    var id = uid(10);
    var profileDir = options.profile || path.join(os.tmpdir(), 'browser-launcher' + id);
...
setups.msedge = setups.chrome; // New MS Edge is Chromium-based, and functions identically.
