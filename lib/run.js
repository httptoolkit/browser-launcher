...
setups.chrome = function( browser, options, callback ) {
    ...
    options.options.proxy && options.options.push('--proxy-server=' + options.proxy);
...
setups.opera = function( browser, options, callback ) {
	...
	options.options = options.options || [];
    generation == 'blink' && options.options.push(browser.profile ? '--user-data-dir=' + browser.profile : null);
